[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/borderlesshq/paystack-go) [![Build Status](https://travis-ci.org/borderlesshq/paystack-go.svg?branch=master)](https://travis-ci.org/borderlesshq/paystack-go) 
